# [Soft UI Dashboard Django](https://appseed.us/product/soft-ui-dashboard/django/)
  ...
  TUTORIAL CRUD: https://www.youtube.com/watch?v=ezIj71CX944&t=251s
...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-09-17 21:45`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3ac64b7a-9a6e-4b9e-9ade-888d5464e87a.git
$ cd 3ac64b7a-9a6e-4b9e-9ade-888d5464e87a
```

# Generated by Django 4.2.3 on 2024-10-26 23:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('numero_propiedad', models.CharField(max_length=5, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(max_length=10)),
                ('propiedad_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.propiedad')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.estadoestacionamiento'),
        ),
        migrations.AddField(
            model_name='estacionamiento',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.tipoestacionamiento'),
        ),
        migrations.AddField(
            model_name='estacionamiento',
            name='ubicacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.ubicacionestacionamiento'),
        ),
        migrations.AddField(

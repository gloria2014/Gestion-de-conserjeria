    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_fin_visita', models.DateTimeField(blank=True, null=True)),
                ('fecha_modifica_reserva', models.DateTimeField(blank=True, null=True)),
                ('estado_estacionamiento', models.CharField(blank=True, max_length=25, null=True)),
                ('id_residente2', models.IntegerField(blank=True, null=True)),
